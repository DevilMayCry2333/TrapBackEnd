...
public interface Device_NaturalEnemies_maintanceEntityMapper {
    ...
    List<Device_NaturalEnemies_maintanceEntity> selectByDateAndColSearch(String customProject,@Param("startDate") String startDate,@Param("endDate") String endDate,String colName,String searchText,Integer num1,Integer num2,String adcode);
